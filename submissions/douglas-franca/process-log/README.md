...
|---|---|---|---|---|
| G0 Setup | 2026-09-16 | `14e3e7f` | Usar a conta `douglasfrannca`; publicar só no meu fork até o PR; eu abro o PR | estrutura, 8 agentes (`.claude/agents/`), permissões que bloqueiam `gh pr create` para a IA |
